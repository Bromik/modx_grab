...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Апр 18 2017 г., 14:27
...
--
-- Дамп данных таблицы `GM9ffqY2CdEh_manager_log`
--

INSERT INTO `GM9ffqY2CdEh_manager_log` (`id`, `user`, `occurred`, `action`, `classKey`, `item`) VALUES
(1, 1, '2017-04-18 14:26:54', 'login', 'modContext', 'mgr');
...
--
-- Дамп данных таблицы `GM9ffqY2CdEh_register_queues`
--

INSERT INTO `GM9ffqY2CdEh_register_queues` (`id`, `name`, `options`) VALUES
...
('4gjbvh1e81j4m3phpaqn3nhr41', 1492514816, 'modx.user.contextTokens|a:1:{s:3:"mgr";i:1;}modx.mgr.user.token|s:52:"modx58f5f7b85d6cd1.07063333_158f5f7fe377099.58536240";modx.mgr.session.cookie.lifetime|i:0;modx.mgr.user.config|a:0:{}');
...
('cultureKey', 'ru', 'modx-combo-language', 'core', 'language', '2017-04-18 11:26:11'),
...
('emailsender', 'admin@ua.fm', 'textfield', 'core', 'authentication', '2017-04-18 11:26:11'),
...
('manager_lang_attribute', 'ru', 'textfield', 'core', 'language', '2017-04-18 11:26:11'),
('manager_language', 'ru', 'modx-combo-language', 'core', 'language', '2017-04-18 11:26:11'),
...
('send_poweredby_header', '1', 'combo-boolean', 'core', 'system', '2017-04-18 11:26:11'),
...
('upload_maxsize', '104857600', 'textfield', 'core', 'file', '2017-04-18 11:26:11'),
...
('use_multibyte', '1', 'combo-boolean', 'core', 'language', '2017-04-18 11:26:11'),
...
('welcome_screen', '', 'combo-boolean', 'core', 'manager', '2017-04-18 11:26:54'),
...
(1, 'admin', 'v1X/4/iwdzxvwP/A3nee6yrM5z7p/K9yxNNGoCRc/E8=', '', 'modUser', 1, NULL, NULL, 'hashing.modPBKDF2', '456bb7808a5dedc5282b98a1752988bd', 1, NULL, 1, 1492514771);
...
(1, 1, 'Администратор по умолчанию', 'admin@ua.fm', '', '', 0, 0, 0, 1, 0, 1492514814, 0, '4gjbvh1e81j4m3phpaqn3nhr41', 0, 0, '', '', '', '', '', '', '', '', '', NULL);
...
(1, 'Default MODX workspace', '{core_path}', '2017-04-18 14:26:01', 1, NULL);
...
--
-- Индексы таблицы `GM9ffqY2CdEh_access_actiondom`
--
ALTER TABLE `GM9ffqY2CdEh_access_actiondom`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `GM9ffqY2CdEh_access_actions`
--
ALTER TABLE `GM9ffqY2CdEh_access_actions`
  ADD PRIMARY KEY (`id`),
  ADD KEY `target` (`target`),
  ADD KEY `principal_class` (`principal_class`),
  ADD KEY `principal` (`principal`),
...
--
-- Индексы таблицы `GM9ffqY2CdEh_access_category`
--
ALTER TABLE `GM9ffqY2CdEh_access_category`
  ADD PRIMARY KEY (`id`),
  ADD KEY `target` (`target`),
  ADD KEY `principal_class` (`principal_class`),
  ADD KEY `principal` (`principal`),
...
--
-- Индексы таблицы `GM9ffqY2CdEh_access_context`
--
ALTER TABLE `GM9ffqY2CdEh_access_context`
  ADD PRIMARY KEY (`id`),
  ADD KEY `target` (`target`),
  ADD KEY `principal_class` (`principal_class`),
  ADD KEY `principal` (`principal`),
...
--
-- Индексы таблицы `GM9ffqY2CdEh_access_elements`
--
ALTER TABLE `GM9ffqY2CdEh_access_elements`
  ADD PRIMARY KEY (`id`),
  ADD KEY `target` (`target`),
  ADD KEY `principal_class` (`principal_class`),
  ADD KEY `principal` (`principal`),
...
--
-- Индексы таблицы `GM9ffqY2CdEh_access_media_source`
--
ALTER TABLE `GM9ffqY2CdEh_access_media_source`
  ADD PRIMARY KEY (`id`),
  ADD KEY `target` (`target`),
  ADD KEY `principal_class` (`principal_class`),
  ADD KEY `principal` (`principal`),
...
--
-- Индексы таблицы `GM9ffqY2CdEh_access_menus`
--
ALTER TABLE `GM9ffqY2CdEh_access_menus`
  ADD PRIMARY KEY (`id`),
  ADD KEY `target` (`target`),
  ADD KEY `principal_class` (`principal_class`),
  ADD KEY `principal` (`principal`),
...
--
-- Индексы таблицы `GM9ffqY2CdEh_access_namespace`
--
ALTER TABLE `GM9ffqY2CdEh_access_namespace`
  ADD PRIMARY KEY (`id`),
  ADD KEY `target` (`target`),
  ADD KEY `principal_class` (`principal_class`),
  ADD KEY `principal` (`principal`),
...
--
-- Индексы таблицы `GM9ffqY2CdEh_access_permissions`
--
ALTER TABLE `GM9ffqY2CdEh_access_permissions`
  ADD PRIMARY KEY (`id`),
  ADD KEY `template` (`template`),
  ADD KEY `name` (`name`);

--
-- Индексы таблицы `GM9ffqY2CdEh_access_policies`
--
ALTER TABLE `GM9ffqY2CdEh_access_policies`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `GM9ffqY2CdEh_access_policy_templates`
--
ALTER TABLE `GM9ffqY2CdEh_access_policy_templates`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `GM9ffqY2CdEh_access_policy_template_groups`
--
ALTER TABLE `GM9ffqY2CdEh_access_policy_template_groups`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `GM9ffqY2CdEh_access_resources`
--
ALTER TABLE `GM9ffqY2CdEh_access_resources`
  ADD PRIMARY KEY (`id`),
  ADD KEY `target` (`target`),
  ADD KEY `principal_class` (`principal_class`),
  ADD KEY `principal` (`principal`),
...
--
-- Индексы таблицы `GM9ffqY2CdEh_access_resource_groups`
--
ALTER TABLE `GM9ffqY2CdEh_access_resource_groups`
  ADD PRIMARY KEY (`id`),
  ADD KEY `target` (`target`),
...
--
-- Индексы таблицы `GM9ffqY2CdEh_access_templatevars`
--
ALTER TABLE `GM9ffqY2CdEh_access_templatevars`
  ADD PRIMARY KEY (`id`),
  ADD KEY `target` (`target`),
  ADD KEY `principal_class` (`principal_class`),
  ADD KEY `principal` (`principal`),
...
--
-- Индексы таблицы `GM9ffqY2CdEh_actiondom`
--
ALTER TABLE `GM9ffqY2CdEh_actiondom`
  ADD PRIMARY KEY (`id`),
  ADD KEY `set` (`set`),
...
--
-- Индексы таблицы `GM9ffqY2CdEh_actions`
--
ALTER TABLE `GM9ffqY2CdEh_actions`
  ADD PRIMARY KEY (`id`),
  ADD KEY `namespace` (`namespace`),
  ADD KEY `controller` (`controller`);

--
-- Индексы таблицы `GM9ffqY2CdEh_actions_fields`
--
ALTER TABLE `GM9ffqY2CdEh_actions_fields`
  ADD PRIMARY KEY (`id`),
  ADD KEY `action` (`action`),
  ADD KEY `type` (`type`),
  ADD KEY `tab` (`tab`);
...
--
-- Индексы таблицы `GM9ffqY2CdEh_active_users`
--
ALTER TABLE `GM9ffqY2CdEh_active_users`
  ADD PRIMARY KEY (`internalKey`);

--
-- Индексы таблицы `GM9ffqY2CdEh_categories`
--
ALTER TABLE `GM9ffqY2CdEh_categories`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `GM9ffqY2CdEh_categories_closure`
--
ALTER TABLE `GM9ffqY2CdEh_categories_closure`
  ADD PRIMARY KEY (`ancestor`,`descendant`);

--
-- Индексы таблицы `GM9ffqY2CdEh_class_map`
--
ALTER TABLE `GM9ffqY2CdEh_class_map`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `GM9ffqY2CdEh_content_type`
--
ALTER TABLE `GM9ffqY2CdEh_content_type`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `name` (`name`);

--
-- Индексы таблицы `GM9ffqY2CdEh_context`
--
ALTER TABLE `GM9ffqY2CdEh_context`
  ADD PRIMARY KEY (`key`),
  ADD KEY `name` (`name`),
  ADD KEY `rank` (`rank`);

--
-- Индексы таблицы `GM9ffqY2CdEh_context_resource`
--
ALTER TABLE `GM9ffqY2CdEh_context_resource`
  ADD PRIMARY KEY (`context_key`,`resource`);

--
-- Индексы таблицы `GM9ffqY2CdEh_context_setting`
--
ALTER TABLE `GM9ffqY2CdEh_context_setting`
  ADD PRIMARY KEY (`context_key`,`key`);

--
-- Индексы таблицы `GM9ffqY2CdEh_dashboard`
--
ALTER TABLE `GM9ffqY2CdEh_dashboard`
  ADD PRIMARY KEY (`id`),
  ADD KEY `name` (`name`),
  ADD KEY `hide_trees` (`hide_trees`);

--
-- Индексы таблицы `GM9ffqY2CdEh_dashboard_widget`
--
ALTER TABLE `GM9ffqY2CdEh_dashboard_widget`
  ADD PRIMARY KEY (`id`),
  ADD KEY `name` (`name`),
  ADD KEY `type` (`type`),
  ADD KEY `namespace` (`namespace`),
...
--
-- Индексы таблицы `GM9ffqY2CdEh_dashboard_widget_placement`
--
ALTER TABLE `GM9ffqY2CdEh_dashboard_widget_placement`
  ADD PRIMARY KEY (`dashboard`,`widget`),
  ADD KEY `rank` (`rank`);

--
-- Индексы таблицы `GM9ffqY2CdEh_documentgroup_names`
--
ALTER TABLE `GM9ffqY2CdEh_documentgroup_names`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `name` (`name`);

--
-- Индексы таблицы `GM9ffqY2CdEh_document_groups`
--
ALTER TABLE `GM9ffqY2CdEh_document_groups`
  ADD PRIMARY KEY (`id`),
  ADD KEY `document_group` (`document_group`),
  ADD KEY `document` (`document`);

--
-- Индексы таблицы `GM9ffqY2CdEh_element_property_sets`
--
ALTER TABLE `GM9ffqY2CdEh_element_property_sets`
  ADD PRIMARY KEY (`element`,`element_class`,`property_set`);

--
-- Индексы таблицы `GM9ffqY2CdEh_extension_packages`
--
ALTER TABLE `GM9ffqY2CdEh_extension_packages`
  ADD PRIMARY KEY (`id`),
  ADD KEY `namespace` (`namespace`),
  ADD KEY `name` (`name`);

--
-- Индексы таблицы `GM9ffqY2CdEh_fc_profiles`
--
ALTER TABLE `GM9ffqY2CdEh_fc_profiles`
  ADD PRIMARY KEY (`id`),
  ADD KEY `name` (`name`),
  ADD KEY `rank` (`rank`),
  ADD KEY `active` (`active`);
...
--
-- Индексы таблицы `GM9ffqY2CdEh_fc_profiles_usergroups`
--
ALTER TABLE `GM9ffqY2CdEh_fc_profiles_usergroups`
  ADD PRIMARY KEY (`usergroup`,`profile`);

--
-- Индексы таблицы `GM9ffqY2CdEh_fc_sets`
--
ALTER TABLE `GM9ffqY2CdEh_fc_sets`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `GM9ffqY2CdEh_lexicon_entries`
--
ALTER TABLE `GM9ffqY2CdEh_lexicon_entries`
  ADD PRIMARY KEY (`id`),
  ADD KEY `name` (`name`),
  ADD KEY `topic` (`topic`),
  ADD KEY `namespace` (`namespace`),
...
--
-- Индексы таблицы `GM9ffqY2CdEh_manager_log`
--
ALTER TABLE `GM9ffqY2CdEh_manager_log`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_occurred` (`user`,`occurred`);

--
-- Индексы таблицы `GM9ffqY2CdEh_media_sources`
--
ALTER TABLE `GM9ffqY2CdEh_media_sources`
  ADD PRIMARY KEY (`id`),
  ADD KEY `name` (`name`),
...
--
-- Индексы таблицы `GM9ffqY2CdEh_media_sources_contexts`
--
ALTER TABLE `GM9ffqY2CdEh_media_sources_contexts`
  ADD PRIMARY KEY (`source`,`context_key`);

--
-- Индексы таблицы `GM9ffqY2CdEh_media_sources_elements`
--
ALTER TABLE `GM9ffqY2CdEh_media_sources_elements`
  ADD PRIMARY KEY (`source`,`object`,`object_class`,`context_key`);

--
-- Индексы таблицы `GM9ffqY2CdEh_membergroup_names`
--
ALTER TABLE `GM9ffqY2CdEh_membergroup_names`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `name` (`name`),
  ADD KEY `parent` (`parent`),
  ADD KEY `rank` (`rank`),
...
--
-- Индексы таблицы `GM9ffqY2CdEh_member_groups`
--
ALTER TABLE `GM9ffqY2CdEh_member_groups`
  ADD PRIMARY KEY (`id`),
  ADD KEY `role` (`role`),
  ADD KEY `rank` (`rank`);

--
-- Индексы таблицы `GM9ffqY2CdEh_menus`
--
ALTER TABLE `GM9ffqY2CdEh_menus`
...
--
-- Индексы таблицы `GM9ffqY2CdEh_namespaces`
--
ALTER TABLE `GM9ffqY2CdEh_namespaces`
  ADD PRIMARY KEY (`name`);

--
-- Индексы таблицы `GM9ffqY2CdEh_property_set`
--
ALTER TABLE `GM9ffqY2CdEh_property_set`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `name` (`name`),
  ADD KEY `category` (`category`);

--
-- Индексы таблицы `GM9ffqY2CdEh_register_messages`
--
ALTER TABLE `GM9ffqY2CdEh_register_messages`
...
--
-- Индексы таблицы `GM9ffqY2CdEh_register_queues`
--
ALTER TABLE `GM9ffqY2CdEh_register_queues`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `name` (`name`);

--
-- Индексы таблицы `GM9ffqY2CdEh_register_topics`
--
ALTER TABLE `GM9ffqY2CdEh_register_topics`
  ADD PRIMARY KEY (`id`),
  ADD KEY `queue` (`queue`),
  ADD KEY `name` (`name`);

--
-- Индексы таблицы `GM9ffqY2CdEh_session`
--
ALTER TABLE `GM9ffqY2CdEh_session`
  ADD PRIMARY KEY (`id`),
  ADD KEY `access` (`access`);

--
-- Индексы таблицы `GM9ffqY2CdEh_site_content`
--
ALTER TABLE `GM9ffqY2CdEh_site_content`
  ADD PRIMARY KEY (`id`),
  ADD KEY `alias` (`alias`),
...
--
-- Индексы таблицы `GM9ffqY2CdEh_site_htmlsnippets`
--
ALTER TABLE `GM9ffqY2CdEh_site_htmlsnippets`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `name` (`name`),
  ADD KEY `category` (`category`),
...
--
-- Индексы таблицы `GM9ffqY2CdEh_site_plugins`
--
ALTER TABLE `GM9ffqY2CdEh_site_plugins`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `name` (`name`),
  ADD KEY `category` (`category`),
  ADD KEY `locked` (`locked`),
...
--
-- Индексы таблицы `GM9ffqY2CdEh_site_plugin_events`
--
ALTER TABLE `GM9ffqY2CdEh_site_plugin_events`
  ADD PRIMARY KEY (`pluginid`,`event`),
  ADD KEY `priority` (`priority`);

--
-- Индексы таблицы `GM9ffqY2CdEh_site_snippets`
--
ALTER TABLE `GM9ffqY2CdEh_site_snippets`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `name` (`name`),
  ADD KEY `category` (`category`),
  ADD KEY `locked` (`locked`),
...
--
-- Индексы таблицы `GM9ffqY2CdEh_site_templates`
--
ALTER TABLE `GM9ffqY2CdEh_site_templates`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `GM9ffqY2CdEh_site_tmplvars`
--
ALTER TABLE `GM9ffqY2CdEh_site_tmplvars`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `name` (`name`),
  ADD KEY `category` (`category`),
  ADD KEY `locked` (`locked`),
...
--
-- Индексы таблицы `GM9ffqY2CdEh_site_tmplvar_access`
--
ALTER TABLE `GM9ffqY2CdEh_site_tmplvar_access`
  ADD PRIMARY KEY (`id`),
  ADD KEY `tmplvar_template` (`tmplvarid`,`documentgroup`);

--
-- Индексы таблицы `GM9ffqY2CdEh_site_tmplvar_contentvalues`
--
ALTER TABLE `GM9ffqY2CdEh_site_tmplvar_contentvalues`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `GM9ffqY2CdEh_site_tmplvar_templates`
--
ALTER TABLE `GM9ffqY2CdEh_site_tmplvar_templates`
  ADD PRIMARY KEY (`tmplvarid`,`templateid`);

--
-- Индексы таблицы `GM9ffqY2CdEh_system_eventnames`
--
ALTER TABLE `GM9ffqY2CdEh_system_eventnames`
  ADD PRIMARY KEY (`name`);

--
-- Индексы таблицы `GM9ffqY2CdEh_system_settings`
--
ALTER TABLE `GM9ffqY2CdEh_system_settings`
  ADD PRIMARY KEY (`key`);

--
-- Индексы таблицы `GM9ffqY2CdEh_transport_packages`
--
ALTER TABLE `GM9ffqY2CdEh_transport_packages`
...
--
-- Индексы таблицы `GM9ffqY2CdEh_transport_providers`
--
ALTER TABLE `GM9ffqY2CdEh_transport_providers`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `name` (`name`),
...
--
-- Индексы таблицы `GM9ffqY2CdEh_users`
--
ALTER TABLE `GM9ffqY2CdEh_users`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `GM9ffqY2CdEh_user_attributes`
--
ALTER TABLE `GM9ffqY2CdEh_user_attributes`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `internalKey` (`internalKey`);

--
-- Индексы таблицы `GM9ffqY2CdEh_user_group_roles`
--
ALTER TABLE `GM9ffqY2CdEh_user_group_roles`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `name` (`name`),
  ADD KEY `authority` (`authority`);

--
-- Индексы таблицы `GM9ffqY2CdEh_user_group_settings`
--
ALTER TABLE `GM9ffqY2CdEh_user_group_settings`
  ADD PRIMARY KEY (`group`,`key`);

--
-- Индексы таблицы `GM9ffqY2CdEh_user_messages`
--
ALTER TABLE `GM9ffqY2CdEh_user_messages`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `GM9ffqY2CdEh_user_settings`
--
ALTER TABLE `GM9ffqY2CdEh_user_settings`
  ADD PRIMARY KEY (`user`,`key`);

--
-- Индексы таблицы `GM9ffqY2CdEh_workspaces`
--
ALTER TABLE `GM9ffqY2CdEh_workspaces`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_access_actiondom`
--
ALTER TABLE `GM9ffqY2CdEh_access_actiondom`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_access_actions`
--
ALTER TABLE `GM9ffqY2CdEh_access_actions`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_access_category`
--
ALTER TABLE `GM9ffqY2CdEh_access_category`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_access_context`
--
ALTER TABLE `GM9ffqY2CdEh_access_context`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_access_elements`
--
ALTER TABLE `GM9ffqY2CdEh_access_elements`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_access_media_source`
--
ALTER TABLE `GM9ffqY2CdEh_access_media_source`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_access_menus`
--
ALTER TABLE `GM9ffqY2CdEh_access_menus`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_access_namespace`
--
ALTER TABLE `GM9ffqY2CdEh_access_namespace`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_access_permissions`
--
ALTER TABLE `GM9ffqY2CdEh_access_permissions`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=220;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_access_policies`
--
ALTER TABLE `GM9ffqY2CdEh_access_policies`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=13;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_access_policy_templates`
--
ALTER TABLE `GM9ffqY2CdEh_access_policy_templates`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_access_policy_template_groups`
--
ALTER TABLE `GM9ffqY2CdEh_access_policy_template_groups`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_access_resources`
--
ALTER TABLE `GM9ffqY2CdEh_access_resources`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_access_resource_groups`
--
ALTER TABLE `GM9ffqY2CdEh_access_resource_groups`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_access_templatevars`
--
ALTER TABLE `GM9ffqY2CdEh_access_templatevars`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_actiondom`
--
ALTER TABLE `GM9ffqY2CdEh_actiondom`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_actions`
--
ALTER TABLE `GM9ffqY2CdEh_actions`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_actions_fields`
--
ALTER TABLE `GM9ffqY2CdEh_actions_fields`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=77;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_categories`
--
ALTER TABLE `GM9ffqY2CdEh_categories`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_class_map`
--
ALTER TABLE `GM9ffqY2CdEh_class_map`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_content_type`
--
ALTER TABLE `GM9ffqY2CdEh_content_type`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_dashboard`
--
ALTER TABLE `GM9ffqY2CdEh_dashboard`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_dashboard_widget`
--
ALTER TABLE `GM9ffqY2CdEh_dashboard_widget`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_documentgroup_names`
--
ALTER TABLE `GM9ffqY2CdEh_documentgroup_names`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_document_groups`
--
ALTER TABLE `GM9ffqY2CdEh_document_groups`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_extension_packages`
--
ALTER TABLE `GM9ffqY2CdEh_extension_packages`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_fc_profiles`
--
ALTER TABLE `GM9ffqY2CdEh_fc_profiles`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_fc_sets`
--
ALTER TABLE `GM9ffqY2CdEh_fc_sets`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_lexicon_entries`
--
ALTER TABLE `GM9ffqY2CdEh_lexicon_entries`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_manager_log`
--
ALTER TABLE `GM9ffqY2CdEh_manager_log`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_media_sources`
--
ALTER TABLE `GM9ffqY2CdEh_media_sources`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_membergroup_names`
--
ALTER TABLE `GM9ffqY2CdEh_membergroup_names`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_member_groups`
--
ALTER TABLE `GM9ffqY2CdEh_member_groups`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_property_set`
--
ALTER TABLE `GM9ffqY2CdEh_property_set`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_register_queues`
--
ALTER TABLE `GM9ffqY2CdEh_register_queues`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_register_topics`
--
ALTER TABLE `GM9ffqY2CdEh_register_topics`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_site_content`
--
ALTER TABLE `GM9ffqY2CdEh_site_content`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_site_htmlsnippets`
--
ALTER TABLE `GM9ffqY2CdEh_site_htmlsnippets`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_site_plugins`
--
ALTER TABLE `GM9ffqY2CdEh_site_plugins`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_site_snippets`
--
ALTER TABLE `GM9ffqY2CdEh_site_snippets`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_site_templates`
--
ALTER TABLE `GM9ffqY2CdEh_site_templates`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_site_tmplvars`
--
ALTER TABLE `GM9ffqY2CdEh_site_tmplvars`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_site_tmplvar_access`
--
ALTER TABLE `GM9ffqY2CdEh_site_tmplvar_access`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_site_tmplvar_contentvalues`
--
ALTER TABLE `GM9ffqY2CdEh_site_tmplvar_contentvalues`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_transport_providers`
--
ALTER TABLE `GM9ffqY2CdEh_transport_providers`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_users`
--
ALTER TABLE `GM9ffqY2CdEh_users`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_user_attributes`
--
ALTER TABLE `GM9ffqY2CdEh_user_attributes`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_user_group_roles`
--
ALTER TABLE `GM9ffqY2CdEh_user_group_roles`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_user_messages`
--
ALTER TABLE `GM9ffqY2CdEh_user_messages`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT для таблицы `GM9ffqY2CdEh_workspaces`
--
ALTER TABLE `GM9ffqY2CdEh_workspaces`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
