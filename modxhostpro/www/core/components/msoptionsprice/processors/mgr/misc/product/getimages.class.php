...
class msProductFileGetListProcessor extends modObjectGetListProcessor
{
    ...
    public function prepareQueryBeforeCount(xPDOQuery $c)
    {
        switch ($this->classKey) {
            case 'msProductFile':
                $thumbnailSize = $this->modx->getOption('ms2_product_thumbnail_size', null, 'small', true);
                ...
                break;
            case 'UserFile':
                $thumbnailSize = $this->modx->getOption('userfiles_image_thumb_default', null, '120x90', true);
